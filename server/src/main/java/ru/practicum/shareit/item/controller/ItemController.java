...
public class ItemController {
    ...
    public ResponseEntity<ResponseCommentDto> createComment(@RequestBody CreateCommentDto createCommentDto,
                                                            @RequestHeader("X-Sharer-User-Id") Long userId,
                                                            @PathVariable Long itemId) {
        log.info("Запрос на добавление отзыва для вещи: {}, c id: {}", createCommentDto, itemId);
